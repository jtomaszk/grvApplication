...
public class GrvItemResource {
    ...
    @Timed
    public ResponseEntity<GrvItemDTO> createGrvItem(@RequestBody GrvItemDTO grvItemDTO) throws URISyntaxException {
    ...
    @Timed
    public ResponseEntity<GrvItemDTO> updateGrvItem(@RequestBody GrvItemDTO grvItemDTO) throws URISyntaxException {
