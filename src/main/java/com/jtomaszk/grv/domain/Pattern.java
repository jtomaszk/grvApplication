...
public class Pattern implements Serializable {
    ...
    public Pattern sources(Set<Source> sources) {
        this.sources = sources;
        return this;
    }

    public Pattern addSources(Source source) {
        this.sources.add(source);
        source.setPattern(this);
        return this;
    }

    public Pattern removeSources(Source source) {
    ...
    public Pattern columns(Set<PatternColumn> patternColumns) {
        this.columns = patternColumns;
        return this;
    }

    public Pattern addColumns(PatternColumn patternColumn) {
        this.columns.add(patternColumn);
        patternColumn.setPattern(this);
        return this;
    }

    public Pattern removeColumns(PatternColumn patternColumn) {
