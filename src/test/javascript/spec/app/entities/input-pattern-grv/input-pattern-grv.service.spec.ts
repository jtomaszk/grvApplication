...
describe('Service Tests', () => {
    ...
    describe('InputPatternGrv Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(InputPatternGrvService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/input-patterns';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return InputPatternGrv', () => {
