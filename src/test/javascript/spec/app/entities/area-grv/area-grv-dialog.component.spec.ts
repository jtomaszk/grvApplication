...
import { AreaGrvDialogComponent } from '../../../../../../main/webapp/app/entities/area-grv/area-grv-dialog.component';
...
describe('Component Tests', () => {
    ...
    describe('AreaGrv Management Dialog Component', () => {
        let comp: AreaGrvDialogComponent;
        let fixture: ComponentFixture<AreaGrvDialogComponent>;
        ...
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [AreaGrvDialogComponent],
                providers: [
                    AreaGrvService
                ]
            })
            .overrideTemplate(AreaGrvDialogComponent, '')
            .compileComponents();
        }));

        beforeEach(() => {
            fixture = TestBed.createComponent(AreaGrvDialogComponent);
