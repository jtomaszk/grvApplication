...
describe('Service Tests', () => {
    ...
    describe('LocationImageGrv Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(LocationImageGrvService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/location-images';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return LocationImageGrv', () => {
