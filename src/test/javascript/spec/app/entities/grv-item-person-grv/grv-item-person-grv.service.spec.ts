...
describe('Service Tests', () => {
    ...
    describe('GrvItemPersonGrv Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(GrvItemPersonGrvService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/grv-item-people';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return GrvItemPersonGrv', () => {
