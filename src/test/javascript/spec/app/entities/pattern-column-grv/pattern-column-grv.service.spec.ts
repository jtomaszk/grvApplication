...
describe('Service Tests', () => {
    ...
    describe('PatternColumnGrv Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(PatternColumnGrvService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/pattern-columns';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return PatternColumnGrv', () => {
