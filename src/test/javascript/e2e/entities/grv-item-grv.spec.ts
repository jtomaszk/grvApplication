...
describe('GrvItem e2e test', () => {
    ...
    it('should create and save GrvItems', () => {
        ...
        grvItemDialogPage.setCoordsInput('coords');
        expect(grvItemDialogPage.getCoordsInput()).toMatch('coords');
        grvItemDialogPage.setExternalidInput('externalid');
        expect(grvItemDialogPage.getExternalidInput()).toMatch('externalid');
        grvItemDialogPage.setExternalboxidInput('externalboxid');
        expect(grvItemDialogPage.getExternalboxidInput()).toMatch('externalboxid');
...
export class GrvItemDialogPage {
    ...
    externalboxidInput = element(by.css('input#field_externalboxid'));
    ...
    setExternalboxidInput = function(externalboxid) {
        this.externalboxidInput.sendKeys(externalboxid);
    };

    getExternalboxidInput = function() {
        return this.externalboxidInput.getAttribute('value');
    };
